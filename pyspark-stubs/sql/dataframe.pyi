...
class DataFrame(PandasMapOpsMixin, PandasConversionMixin, Generic[T]):
    ...
    @overload
    def repartitionByRange(
        self, *cols: ColumnOrName[T, LiteralString]
    ) -> DataFrame: ...
    ...
    def sampleBy(
        self, col: ColumnOrName, fractions: dict[Any, float], seed: int | None = None
    ) -> DataFrame: ...
    def randomSplit(
    ...
    def unpivot(
        self,
        ids: ColumnOrName | list["ColumnOrName"] | tuple["ColumnOrName", ...],
        values: ColumnOrName | list["ColumnOrName"] | tuple["ColumnOrName", ...] | None,
